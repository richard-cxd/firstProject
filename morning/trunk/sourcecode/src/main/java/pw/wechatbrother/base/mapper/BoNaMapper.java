...
public interface BoNaMapper {
    ...
    //告警数据上报
    Map addGJ(@Param("jcdId")String jcdId, @Param("DataDate")String dataDate, @Param("level")String level,@Param("type")String type,@Param("msg")String msg,@Param("lastdata")String lastdata);
    //查询告警数据
    Map selectAlarm(Map map);
