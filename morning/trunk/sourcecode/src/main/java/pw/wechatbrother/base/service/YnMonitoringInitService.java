...
public interface YnMonitoringInitService {
    ...
    DetailDTO selectCountMonitringAndEnterprise(MonitoringObjectDTO monitoringObjectDTO, LoginAppDTO appLoginUser, ArrayList<String> serviceAreas);
    ...
    //首页   电度
    DetailDTO selectSYPower(MonitoringObjectDTO monitoringObjectDTO, LoginAppDTO appLoginUser,String userType);


    //首页   终端数   总容量
    DetailDTO selectSYCountAndRL(MonitoringObjectDTO monitoringObjectDTO, LoginAppDTO appLoginUser,String userType,OnLineMonitoringDTO onLineMonitoringDTO);
