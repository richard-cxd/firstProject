...
//===================================================================================================================================================
    ...
    public DetailDTO selectEnterpriseSubstationHaveMonitoringPoint(MonitoringObjectDTO monitoringObjectDTO, LoginAppDTO appLoginUser) {
        DetailDTO detailDTO = new DetailDTO(true);
        monitoringObjectDTO.setTableNameString("jc_gj_"+monitoringObjectDTO.getYnBaseStaffCompanyId());
        List<LinkedHashMap> mapList=ynBaseMapper.selectEnterpriseSubstationHaveMonitoringPoint(monitoringObjectDTO);
       /* Map returnMap = new HashMap();
        if(mapList!=null &&mapList.size()>0){
            returnMap.put("resultList", mapList);
        }else{q
    ...
    public DetailDTO selectEnterpriseInfoByCompanyIdAndEnterpriseName(MonitoringObjectDTO monitoringObjectDTO, LoginAppDTO appLoginUser) {
        ...
        List<LinkedHashMap> mapList=ynBaseMapper.selectEnterpriseInfoByCompanyIdAndEnterpriseName(monitoringObjectDTO);
       /* Map returnMap = new HashMap();
        if(mapList!=null &&mapList.size()>0){
            returnMap.put("resultList", mapList);
        }else{
